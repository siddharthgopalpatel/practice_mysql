...
<<<<<<< HEAD
CREATE TABLE Players_list (Player VARCHAR(255), Span INT, Mat INT, Inning INT, Notout INT, Runs INT, HS INT, Avg INT, Centuary INT, Half-Centuary INT, Zero INT, PRIMARY KEY (RUNS));
=======
...
>>>>>>> 54cbd1eb58ff29c08aac496ee0dae33793abba4f
